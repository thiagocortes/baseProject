    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    <div class="content">
                    	<spring:url value="${professor.id == null ? '/professor/salvar' :  '/professor/atualizar'}" var="save"/>
                    	<springform:form method="POST" action="${save}" modelAttribute="professor">
                    	<springform:hidden path="id" />
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <springform:input type="text" id="dataNascimento" path="dataNascimento" cssClass="form-control border-input" />
                            ...
                            <div class="text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/professor/cancelar" class="btn btn-danger btn-fill btn-wd">Cancelar</a> 
                            </div>
